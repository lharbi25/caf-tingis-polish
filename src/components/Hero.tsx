  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        {/* Main Title */}
        <h1
          className="font-display text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-foreground mb-4 animate-fade-in drop-shadow-2xl"
        ...
        >
          ...
          <a
            ...
            className="flex items-center gap-2 px-7 sm:px-9 py-4 bg-primary text-primary-foreground rounded-full font-medium hover:bg-gold-dark transition-all duration-300 w-full sm:w-auto sm:min-w-[180px] justify-center text-base sm:text-lg shadow-xl shadow-primary/20 hover:shadow-2xl hover:shadow-primary/30 hover:-translate-y-0.5 active:translate-y-0"
          >
          ...
          <button
            ...
            className="px-7 sm:px-9 py-4 border-2 border-primary text-primary rounded-full font-medium hover:bg-primary hover:text-primary-foreground transition-all duration-300 w-full sm:w-auto sm:min-w-[180px] text-base sm:text-lg hover:shadow-lg hover:shadow-primary/10 hover:-translate-y-0.5 active:translate-y-0"
          >
            {t.hero.reserveTable}
          </button>
          ...
          <button
            ...
            className="flex items-center gap-2 px-7 sm:px-9 py-4 border border-foreground/30 text-foreground rounded-full font-medium hover:border-primary hover:text-primary transition-all duration-300 w-full sm:w-auto sm:min-w-[180px] justify-center text-base sm:text-lg hover:-translate-y-0.5 active:translate-y-0"
          >
        ...
        {/* Stats */}
        <div
          className="grid grid-cols-3 gap-6 md:gap-8 max-w-lg mx-auto animate-fade-in px-4"
